...
const HomePage = ({}) => {
	...
	const tools = [
		...
		{
			title: "Word to HTML Builder",
			description: "Generate an Easy Read HTML from a Word or InDesign document."
		},
		{
			title: "Easy Read Alt Text Generator",
			description:
	...
	return (
		<>
			<header className="px-12 flex gap-4 flex-col items-center my-20 container">
				<img src={icon.src} alt="IAG Icon" className="w-16" />
				<h1 className="font-bold text-navy-100 text-3xl">Tools & Databases</h1>
			</header>
			<main className="px-12 mt-4 container mb-20">
